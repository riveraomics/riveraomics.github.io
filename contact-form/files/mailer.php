...
$email = "riverao2@uagm.edu";

//array of fields in form. (In the format "field_name" => "field_label")
$form_fields = array(
"element0" => 'Your Full Name',
"element1" => 'Email (uagm.edu)',
"element2" => 'Phone number (optional)',
"element3" => 'Subject',
"element4" => 'Briefly describe your background in science',
"element5" => 'Describe your career goals.',
"element6" => 'Describe how RNA bioinformatics fits into your career goals.',
"element7" => 'Resume or CV (optional)'
);

$required_fields = array("element0", "element1", "element3", "element4", "element5", "element6");
